import contact from "../image/image/contact.jpg";
import customerservice from "../image/image/customerservice.jpg";
import feedback from "../image/image/feedback.png";
import partnership from "../image/image/pngtree-business-partnership-via-online-png-image_3218801.jpg";
    ...
    <>
      ...
      <div className="row justify-content-center gap-5 mt-5">
        <div className="col-2 text-center text-center">
          <img src={customerservice} height={300} alt="CustomerSupportImg" />
        ...
        <div className="col-2 text-center">
          <img src={partnership} height={300} alt="PartnershipImg" />
        ...
        <div className="col-2 text-center">
          <img src={feedback} alt="FeedbackImg" height={300} />
